...
@section('page-header', 'Modifier une pièce')

@section('content')

<form action="{{ route('admin.pieces.update', $piece->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    ...
    <div class="kit-container space-y-4">
        ...
        @error('box_id') <p class="text-error">{{ $message }}</p> @enderror
